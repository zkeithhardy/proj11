...
public class CodeAreaContextMenu extends ContextMenu {
    ...
    public CodeAreaContextMenu(MasterController controller){
        ...
        MenuItem CompileMenuItem=new MenuItem();
        MenuItem CompileAndRunMenuItem=new MenuItem();
        ...
        CompileMenuItem.setOnAction(event->controller.handleCompile());
        CompileAndRunMenuItem.setOnAction(event->controller.handleCompileAndRun());
        ...
        CompileAndRunMenuItem.setText("Compile And Run");
        ...
        this.getItems().addAll(UndoMenuItem,RedoMenuItem,CutMenuItem,CopyMenuItem,PasteMenuItem,SelectAllMenuItem,
                FindAndReplaceMenuItem,EnTabMenuItem,DeTabMenuItem,CompileMenuItem,CompileAndRunMenuItem);
