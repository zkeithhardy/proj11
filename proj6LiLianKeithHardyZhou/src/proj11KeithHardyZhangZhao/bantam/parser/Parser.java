 ...
 */
package proj11KeithHardyZhangZhao.bantam.parser;

import static proj11KeithHardyZhangZhao.bantam.lexer.Token.Kind.*;
...
public class Parser
{
	...
	private Expr parsePrimary() {
        ...
        //--------------------------------------------End of cases------------------------------------------------------
        while(currentToken.kind == DOT || currentToken.kind == LPAREN || currentToken.kind == LBRACKET){
